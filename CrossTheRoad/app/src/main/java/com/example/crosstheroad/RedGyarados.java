...
public class RedGyarados extends RoadObstacle {
    RedGyarados(Resources r, Context context, int duration, int y) {
    ...
    void setGraphic() {
        ...
        graphic.setImageDrawable(super.r.getDrawable(R.drawable.octopus));
