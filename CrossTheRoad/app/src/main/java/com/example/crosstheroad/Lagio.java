...
public class Lagio extends RoadObstacle {
    Lagio(Resources r, Context context, int duration, int y) {
    ...
    void setGraphic() {
        ...
        FrameLayout.LayoutParams frameParams =
                new FrameLayout.LayoutParams(Background.getTileLength() * 2,
                        Background.getTileLength(), Gravity.RIGHT);
        graphic.setLayoutParams(frameParams);
        graphic.setImageDrawable(super.r.getDrawable(R.drawable.lagio));
