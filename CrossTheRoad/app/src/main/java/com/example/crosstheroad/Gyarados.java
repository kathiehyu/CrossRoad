...
public class Gyarados extends RoadObstacle {

    public Gyarados(Resources r, Context context, int duration, int y) {
    ...
    public void setGraphic() {
        ...
        graphic.setImageDrawable(super.r.getDrawable(R.drawable.gyarados));
