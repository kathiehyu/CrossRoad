...
public class SeaHorse extends RoadObstacle {

    public SeaHorse(Resources r, Context context, int duration, int y) {
    ...
    public void setGraphic() {
        ...
        graphic.setImageDrawable(super.r.getDrawable(R.drawable.seahorse));
