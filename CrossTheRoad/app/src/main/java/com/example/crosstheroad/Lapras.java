...
public class Lapras extends RoadObstacle {
    Lapras (Resources r, Context context, int duration, int y) {
    ...
    void setGraphic() {
        ...
        graphic.setImageDrawable(super.r.getDrawable(R.drawable.lapras));
