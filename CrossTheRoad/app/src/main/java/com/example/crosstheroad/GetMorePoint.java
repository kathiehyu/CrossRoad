...
public abstract class GetMorePoint extends Moveable {
    private float start;
    private float end;

    GetMorePoint(Resources r, Context context, int duration, int row, int length, float start, float end) {
